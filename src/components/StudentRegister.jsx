...
export default function StudentRegister () {
  ...
  const formik = useFormik ({
    ...
    onSubmit: async (values, {setSubmitting, resetForm}) => {
      try {
        ...
        setTimeout (() => {
          navigate (`/register-parent/${response.result.studentId}`);
        }, 2000);
        resetForm ();
      } catch (error) {
  ...
  return (
    <div>
      <div
        className={`${isDarkMode ? 'bg-[#0d192f]' : 'bg-white'} flex justify-center  py-4 px-3`}
      >
        <Toaster position="top-center" reverseOrder={false} />
        <div
          className={`${isDarkMode ? 'bg-[#152f54] bg-opacity-40' : 'bg-[#b9d7f1] bg-opacity-30'} flex flex-col gap-8 max-w-full   mx-auto px-16 py-6 w-[90%]`}
        >
                  ...
                  <div className="flex flex-col grow shrink-0 basis-0 w-fit max-md:max-w-full">
                    <div className="flex gap-5 max-md:flex-wrap">
                      <div className="flex flex-col flex-1 grow shrink-0 basis-0 w-fit max-md:max-w-full">
                        ...
                        <input
                          ...
                          className={`${isDarkMode ? 'text-white bg-[#152f54] bg-opacity-40' : 'text-black bg-white bg-opacity-30'} justify-center items-start px-3.5 py-3 mb-4 text-sm whitespace-nowrap  rounded-md border border-violet-300 border-solid  max-md:pr-5 max-md:max-w-full`}
                        />
                    ...
                    <div className="flex gap-5 max-md:flex-wrap mt-3">
                      ...
                      <div className="flex flex-col flex-1 grow shrink-0 basis-0 w-fit max-md:max-w-full">
                        ...
                        >
                          <option
                            className={`${isDarkMode ? 'text-white bg-[#152f54]' : ''}`}
                            value=""
                          >
                            Select Gender
                          </option>
                    ...
                    <div className="flex justify-end mt-3 mr-3">
                      <button
                        ...
                        className={`${isDarkMode ? 'text-white bg-[#152f54] bg-opacity-30' : ' bg-sky-950 text-white'} justify-center items-center px-6 py-1.5 text-xl font-bold  rounded border-2 border-solid border-sky-950 max-w-[203px] `}
                      >
                        Save
                      </button>
                    </div>
