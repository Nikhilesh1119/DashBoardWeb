                ...
                {sections.length === 0 ? (
                  ...
                  <div className="mt-8 flex flex-wrap gap-4  p-5">
                    {sections.map((itm) => (
                      <div
                        key={itm["_id"]}
                        className="grid grid-cols-12 w-full border-2 bg-blue-950 border-black px-2 py-2 rounded-full mx-8"
                      >
                        <div className=" col-span-10 flex justify-between border-2 bg-slate-100 border-white border-r-0 rounded-l-full">
                          <div className="flex justify-center  items-center text-3xl font-semibold  rounded-l-full px-4 bg-yellow-300">
                            {itm.name}
                          </div>
                          <div className=" px-5 flex flex-col ">
                            <div className="text-xl font-semibold">
                              {itm.classTeacher.firstname.toUpperCase()}
                            </div>
                            <div className="text-sm">
                              {itm.classTeacher.username}
                            </div>
                          </div>
                        </div>
