...
function Addsection() {
  ...
  const getClassSection = async () => {
    const res = await getSection(newSection.classId);
          ...
          >
            ...
            {sections.length === 0 ? (
              <div className="flex flex-col justify-center items-center mt-20">
                ...
                >
                  Section will appear here after you create it using add section
                  button above
                </p>
              </div>
            ) : (
                  ...
                  <div className="mb-4">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        const selectedTeacher = teachers.find(
                          (teacher) => teacher.username === e.target.value
                        );
                        setNewSection({
                          ...newSection,
                    ...
                    >
                      ...
                      {teachers.map((teacher, i) => (
                        <option key={i} value={teacher.username}>
                          {teacher.username}
                        </option>
                      ))}
                    </select>
