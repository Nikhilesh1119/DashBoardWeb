      ...
      >
        <div className="mb-4 flex">
          <div className="border border-red-500 inline-block bg-white">
            <button
              className={`${isDarkMode ? 'bg-[#152f54]' : 'bg-white'} text-[#ed0c57] font-bold py-2 px-2 `}
            >
              <Link to="/register-teacher" className="text-red-500 no-underline">
                + new Teacher
              </Link>
            </button>
            <button
        ...
        <div className="mb-4 flex  items-center">
          ...
          <input
            ...
            className={`${isDarkMode ? 'bg-[#0d192f] text-white hover:text-[#0d192f] hover:bg-gray-200' : 'bg-white text-gray-600 '} py-2 px-4 ml-4 rounded-md w-full  border border-gray-300 shadow-sm`}
          />
          <button
